...
$<a_1,a_2,... ,a_n>$下，得到最可能的目标值$V_{MAP}$。


$$
    \begin{aligned}
        v_{MAP} & ={arg\max}_{v_j}P(v_j|a_1,a_2,... ,a_n)                                \\      
                & ={arg\max}_{v_j\in V}\frac{P(a_1,a_2,... ,a_n)P(v_j)}{P(a_1,a_2,... ,a_n)} \\
                & ={arg\max}_{v_j\in V}P(a_1,a_2,...,a_n)P(v_j)                         \\       
